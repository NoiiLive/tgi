...
function FactionTab.Build(frame, FactionEvent)
	...
	ghoulBtn.MouseButton1Click:Connect(function() FactionEvent:FireServer("GHOUL") end)
	ccgBtn.MouseButton1Click:Connect(function() FactionEvent:FireServer("CCG") end)
end
return FactionTab